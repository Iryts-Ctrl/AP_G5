...
public class HomePage extends Application {
    ...
    public void loadExerciseToHome() {
        ...
        File file = new File("C:\\Users\\User\\IdeaProjects\\AP_G5\\src\\main\\java\\Assignment\\exerciseHome.txt");
        try (Scanner scanner = new Scanner(file)) {
    ...
    public void loadNutritionToHome() {
        ...
        File file = new File("C:\\Users\\User\\IdeaProjects\\AP_G5\\src\\main\\java\\Assignment\\foodHome.txt");
        try (Scanner scanner = new Scanner(file)) {
    ...
    public void loadUsernameToHome() {
        ...
        File file = new File("C:\\Users\\User\\IdeaProjects\\AP_G5\\src\\main\\java\\Assignment\\usernameHome.txt");
        try (Scanner scanner = new Scanner(file)) {
